...
public class DonneesSimulation {
    ...
    /**
     * Ajouter une case à la simulation, à la place (ligne,colonne) à partir du coin supérieur gauche.
     ...
     * @throws ConstructionException si les coordonnées sont à l'extérieur des limites de la carte
     */
     ...
     * @throws ConstructionException si la case est en-dehors des limites de la carte
     */
     ...
     * @return Booléen indiquant si la case est en-dehors des limites de la carte
     */
     ...
     * @param eau Intensité de l'incendie, en litres d'eau nécessaires pour l'éteindre
     * @throws ConstructionException si la position de l'incendie est hors des limites de la carte
     */
     ...
     * @throws ConstructionException si la position du robot est hors des limites de la carte
     */
