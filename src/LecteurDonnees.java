...
public class LecteurDonnees {
    ...
    /**
     * Lit un fichier de données et crée la structure de données nécessaire au stockage.
     * Méthode de classe, utilisation: LecteurDonnees.creeDonnees(fichierDonnees).
